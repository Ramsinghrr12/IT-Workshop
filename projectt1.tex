...
\begin{abstract}
	...
	out more about adding images to your documents in this help article on including images on Overleaf.
		...
		\includegraphics[width=0.3\textwidth]{i1.jpeg}
...
\begin{enumerate}
 ...
 \end{enumerate}
	 ...
	 ATEX is great at typesetting mathematics. Let X1 , X2 , . . . , Xn be a sequence of independent and
	 identically distributed random variables with E[Xi ] = µ and Var[Xi ] = σ 2 < ∞, and let
	 
	 sn=$\frac{X1 + X2 +X3+.....Xn}{n} =$$\frac{1}{n}$ $\sum_{i}^{n} Xi$
	 ...
	 sually the template you’re using will have the page margins and paper size set correctly for that
	 ...
	 the Overleaf menu — or use the contact form at
	 	...
	 	\href{www.overleaf.com}{https://www.overleaf.com}
